...
var Card$1 = /*#__PURE__*/React__namespace.forwardRef(function Card(props, ref) {
  var classes = props.classes,
      className = props.className,
...
var Link = /*#__PURE__*/React__namespace.forwardRef(function Link(props, ref) {
  ...
  return /*#__PURE__*/React__namespace.createElement(Typography$1, _extends({
...
var Image = function (_a) {
    ...
    return React__default["default"].createElement(Box$1, { "data-testid": "Image", className: "amp-dc-image-holder" }, imageTag);
};
...
var Banner = function (_a) {
    ...
    return (React__default["default"].createElement(Box$1, { className: "container", "data-testid": "Banner" },
        React__default["default"].createElement(Image, __assign({}, image)),
        React__default["default"].createElement(Box$1, { className: alignement.join(" "), style: { opacity: opacity, textAlign: 'left' } },
            (bannerText === null || bannerText === void 0 ? void 0 : bannerText.header) && (React__default["default"].createElement(Typography$1, { variant: "h2", component: "h2" }, bannerText.header)),
            (bannerText === null || bannerText === void 0 ? void 0 : bannerText.subheader) && (React__default["default"].createElement(Typography$1, { variant: "h3", component: "h3" }, bannerText.subheader)),
            (bannerText === null || bannerText === void 0 ? void 0 : bannerText.description) && (React__default["default"].createElement(Typography$1, { variant: "body1", component: "p" }, bannerText.description)),
            (ctaSettings === null || ctaSettings === void 0 ? void 0 : ctaSettings.buttonText) && (React__default["default"].createElement(Box$1, { style: { textAlign: 'right' } },
                React__default["default"].createElement(Button$1, { href: ctaSettings === null || ctaSettings === void 0 ? void 0 : ctaSettings.linkUrl }, ctaSettings.buttonText))))));
};
...
var Card = function (_a) {
    ...
    return (React__default["default"].createElement(Grid$1, { item: true, xs: 12, sm: true, className: "card-root", "data-testid": "Card" },
        React__default["default"].createElement(MuiCard, { className: "card-container" },
            React__default["default"].createElement(CardContent$1, { className: "card-content" },
                image && (React__default["default"].createElement(Image, __assign({}, image))),
                cardName && (React__default["default"].createElement(Typography$1, { variant: "h2", component: "h2", style: { marginTop: 15, marginBottom: 15 } }, cardName)),
                description && (React__default["default"].createElement(Typography$1, { component: "p" }, description))),
            React__default["default"].createElement(CardActions$1, { className: "card-actions" }, links && links.map(function (link, i) {
                if (link.label) {
                    return (React__default["default"].createElement(Button$1, { className: "card-links", href: link.value, key: i }, link.label));
                }
                else {
                    return null;
                }
...
var CardList = function (_a) {
    ...
    return (React__default["default"].createElement(Box$1, { "data-testid": "CardList" },
        header && (React__default["default"].createElement(Typography$1, { variant: "h2", component: "h2" }, header)),
        cards && (React__default["default"].createElement(Grid$1, { container: true }, cards.map(function (card, index) {
...
var ExpandMore = createSvgIcon( /*#__PURE__*/React__namespace.createElement("path", {
        ...
        overrides: {
            ...
            li: {
                component: function () { return (React__default["default"].createElement("li", null,
                    React__default["default"].createElement(Typography$1, { variant: "body1", component: "span" }))); }
            }
        }
    };
    return (React__default["default"].createElement(Box$1, { "data-testid": "FAQ", className: "amp-faq" },
        React__default["default"].createElement(Typography$1, { variant: "h3", component: "h3", align: "center" }, header),
        React__default["default"].createElement(Box$1, { style: { marginTop: 30 } }, items && items.map(function (item, i) {
            return React__default["default"].createElement(Box$1, { key: i },
                React__default["default"].createElement(Accordion$1, null,
                    React__default["default"].createElement(AccordionSummary$1, { expandIcon: React__default["default"].createElement(ExpandMore, null) },
                        React__default["default"].createElement(Typography$1, { variant: "h4", component: "p" }, item.question)),
                    React__default["default"].createElement(AccordionDetails$1, { className: "amp-faq" }, item.answer && React__default["default"].createElement(ReactMarkdown, { options: options }, item.answer))));
        }))));
};
        ...
        overrides: {
            ...
            li: {
                component: function (props) { return (React__default["default"].createElement("li", null,
                    React__default["default"].createElement(Typography$1, __assign({}, props, { variant: "body1", component: "span" })))); }
            }
        }
    };
    return (React__default["default"].createElement(Box$1, { "data-testid": "Text", className: "amp-text", style: { textAlign: align } }, text && React__default["default"].createElement(ReactMarkdown, { options: options }, text)));
};
...
var Video = function (_a) {
    ...
    return (React__default["default"].createElement(Box$1, { "data-testid": "Video", className: 'amp-dc-video-wrap' },
        ...
        React__default["default"].createElement(Box$1, { className: "pause-button inactive" })));
};
