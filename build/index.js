...
var Image = function (_a) {
    ...
    var source = function (_a) {
        ...
        return React__default["default"].createElement("source", { srcSet: buildSrcUrl({ width: width, format: format, poiAspect: poiAspect }) + " 1x, " + buildSrcUrl({ width: highDensityWidth, format: format, poiAspect: poiAspect }), media: minWidth ? "(min-width: " + minWidth + "px)" : (maxWidth ? "(max-width: " + maxWidth + "px)" : undefined), type: format ? "image/" + format : undefined });
    };
    var imageTag = display == 'Static' ? (React__default["default"].createElement("picture", { className: "amp-dc-image" },
        React__default["default"].createElement("img", { "data-testid": "Image-ImgTag", loading: "lazy", src: "//" + image.endpoint + ".a.bigcontent.io/v1/static/" + image.name, className: "amp-dc-image-pic", alt: imageAltText }))) : (React__default["default"].createElement("picture", { className: "amp-dc-image" },
        ...
        React__default["default"].createElement("img", { "data-testid": "Image-ImgTag", loading: "lazy", src: buildSrcUrl({ width: '1600' }), className: "amp-dc-image-pic", alt: imageAltText })));
    return React__default["default"].createElement(core.Box, { "data-testid": "Image", className: "amp-dc-image-holder" }, imageTag);
};
...
var Banner = function (_a) {
    ...
    return (React__default["default"].createElement(core.Box, { className: "container", "data-testid": "Banner" },
        React__default["default"].createElement(Image, __assign({}, image)),
        React__default["default"].createElement(core.Box, { className: alignement.join(" "), style: { opacity: opacity, textAlign: 'left' } },
            (bannerText === null || bannerText === void 0 ? void 0 : bannerText.header) && (React__default["default"].createElement(core.Typography, { variant: "h2", component: "h2" }, bannerText.header)),
            (bannerText === null || bannerText === void 0 ? void 0 : bannerText.subheader) && (React__default["default"].createElement(core.Typography, { variant: "h3", component: "h3" }, bannerText.subheader)),
            (bannerText === null || bannerText === void 0 ? void 0 : bannerText.description) && (React__default["default"].createElement(core.Typography, { variant: "body1", component: "p" }, bannerText.description)),
            (ctaSettings === null || ctaSettings === void 0 ? void 0 : ctaSettings.buttonText) && (React__default["default"].createElement(core.Box, { style: { textAlign: 'right' } },
                React__default["default"].createElement(core.Button, { href: ctaSettings === null || ctaSettings === void 0 ? void 0 : ctaSettings.linkUrl }, ctaSettings.buttonText))))));
};
...
var Card = function (_a) {
    ...
    return (React__default["default"].createElement(core.Grid, { item: true, xs: 12, sm: true, className: "card-root", "data-testid": "Card" },
        React__default["default"].createElement(core.Card, { className: "card-container" },
            React__default["default"].createElement(core.CardContent, { className: "card-content" },
                image && (React__default["default"].createElement(Image, __assign({}, image))),
                cardName && (React__default["default"].createElement(core.Typography, { variant: "h2", component: "h2", style: { marginTop: 15, marginBottom: 15 } }, cardName)),
                description && (React__default["default"].createElement(core.Typography, { component: "p" }, description))),
            React__default["default"].createElement(core.CardActions, { className: "card-actions" }, links && links.map(function (link, i) {
                if (link.label) {
                    return (React__default["default"].createElement(core.Button, { className: "card-links", href: link.value, key: i }, link.label));
                }
                else {
                    return null;
                }
...
var FAQ = function (_a) {
    ...
    var options = {
        overrides: {
            h1: { component: core.Typography, props: { variant: 'h1' } },
            h2: { component: core.Typography, props: { variant: 'h2' } },
            h3: { component: core.Typography, props: { variant: 'h3' } },
            h4: { component: core.Typography, props: { variant: 'h4' } },
            h5: { component: core.Typography, props: { variant: 'h5' } },
            h6: { component: core.Typography, props: { variant: 'h6' } },
            p: { component: core.Typography, props: { variant: 'body1', gutterBottom: true } },
            a: { component: core.Link },
            li: {
                component: function () { return (React__default["default"].createElement("li", null,
                    React__default["default"].createElement(core.Typography, { variant: "body1", component: "span" }))); }
            }
        }
    };
    return (React__default["default"].createElement(core.Box, { "data-testid": "FAQ", className: "amp-faq" },
        React__default["default"].createElement(core.Typography, { variant: "h3", component: "h3", align: "center" }, header),
        React__default["default"].createElement(core.Box, { style: { marginTop: 30 } }, items && items.map(function (item, i) {
            return React__default["default"].createElement(core.Box, { key: i },
                React__default["default"].createElement(core.Accordion, null,
                    React__default["default"].createElement(core.AccordionSummary, { expandIcon: React__default["default"].createElement(icons.ExpandMore, null) },
                        React__default["default"].createElement(core.Typography, { variant: "h4", component: "p" }, item.question)),
                    React__default["default"].createElement(core.AccordionDetails, { className: "amp-faq" }, item.answer && React__default["default"].createElement(ReactMarkdown, { options: options }, item.answer))));
        }))));
};
...
var Text = function (_a) {
    ...
    var options = {
        overrides: {
            h1: { component: core.Typography, props: { style: { marginTop: 20 }, gutterBottom: true, variant: 'h1', component: 'h1' } },
            h2: { component: core.Typography, props: { style: { marginTop: 20 }, gutterBottom: true, variant: 'h2', component: 'h2' } },
            h3: { component: core.Typography, props: { style: { marginTop: 20 }, gutterBottom: true, variant: 'h3', component: 'h3' } },
            h4: { component: core.Typography, props: { style: { marginTop: 20 }, gutterBottom: true, variant: 'h4', component: 'h4' } },
            h5: { component: core.Typography, props: { style: { marginTop: 20 }, gutterBottom: true, variant: 'h5', component: 'h5' } },
            h6: { component: core.Typography, props: { style: { marginTop: 20 }, gutterBottom: true, variant: 'h6', component: 'h6' } },
            p: { component: core.Typography, props: { variant: 'body1', component: 'p', gutterBottom: true } },
            a: { component: core.Link },
            ...
            li: {
                component: function (props) { return (React__default["default"].createElement("li", null,
                    React__default["default"].createElement(core.Typography, __assign({}, props, { variant: "body1", component: "span" })))); }
            }
        }
    };
    return (React__default["default"].createElement(core.Box, { "data-testid": "Text", className: "amp-text", style: { textAlign: align } }, text && React__default["default"].createElement(ReactMarkdown, { options: options }, text)));
};
...
var Video = function (_a) {
    ...
    return (React__default["default"].createElement(core.Box, { "data-testid": "Video", className: 'amp-dc-video-wrap' },
        React__default["default"].createElement("video", { className: "amp-dc-video", poster: "https://" + video.defaultHost + "/v/" + video.endpoint + "/" + video.name + "?protocol=https", controls: true, src: "https://" + video.defaultHost + "/v/" + video.endpoint + "/" + video.name + "/mp4_720p?protocol=https" },
            React__default["default"].createElement("source", { src: "https://" + video.defaultHost + "/v/" + video.endpoint + "/" + video.name + "/mp4_720p?protocol=https", "data-res": "High", "data-bitrate": "2119", "data-label": "High", type: "video/mpeg4" }),
            React__default["default"].createElement("source", { src: "https://" + video.defaultHost + "/v/" + video.endpoint + "/" + video.name + "/mp4_480p?protocol=https", "data-res": "Medium", "data-bitrate": "689", "data-label": "Medium", type: "video/mpeg4" }),
            React__default["default"].createElement("source", { src: "https://" + video.defaultHost + "/v/" + video.endpoint + "/" + video.name + "/webm_480p?protocol=https", "data-res": "Medium", "data-bitrate": "624", "data-label": "Medium", type: "video/webm" })),
        React__default["default"].createElement(core.Box, { className: "pause-button inactive" })));
};
